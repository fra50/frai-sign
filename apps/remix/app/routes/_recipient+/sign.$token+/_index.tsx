        ...
        <div className="relative mt-2 flex w-full flex-col items-center">
          ...
          {user ? (
            ...
            <p className="mt-36 text-muted-foreground/60 text-sm">
              <Trans>
                FRAI Sign is open-source software.{' '}
                <Link to="https://github.com/fra50/frai-sign" className="text-documenso-700 hover:text-documenso-600">
                  View source and license notices
                </Link>
                .
              </Trans>
            </p>
